...
if __name__ == '__main__':
    ...
    parser.add_argument('--pb_path', type=str, help='path to save tensorflow pb model', default='./export/serving/2')
    parser.add_argument('--checkpoint_path', type=str, help='path to tensorflow model', default='./checkpoint/model-600000')
